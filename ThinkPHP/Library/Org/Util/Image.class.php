...
class Image {
     ...
     * @return string
     */
    static function buildImageVerify($length=4, $mode=1, $type='png', $width=48, $height=22, $verifyName='verify', $fontface='simhei.ttf') {
...
//            imagestring($im, 5, $i * 10 + 5, mt_rand(1, 8), $randval{$i}, $stringColor);
            imagestring($im, 5, ($width/$length) * $i, mt_rand(1, $height/2), $randval{$i}, $stringColor);
//            imagettftext($im, mt_rand(16, 20), mt_rand(-60, 60), ($width/$length) * $i, mt_rand(1, $height/2), $stringColor, $fontface, $randval);
        }
